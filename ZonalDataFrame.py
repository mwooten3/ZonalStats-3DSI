...
#* FUNCTIONNS TD?
#* Like maybe function to post-process DF
#* Functions to save to .csv and .shp?
#* Function to drop rows if all new columns are NaN
#* Function to replace NaN with NoData value from raster ?
...
class ZonalDataFrame(object):
    ...
    def zonalStats(self, raster, layerDict = None):
        ...
        from RasterStats import ZonalStats
